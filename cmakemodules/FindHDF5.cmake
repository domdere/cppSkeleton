...
STRING ( REGEX REPLACE ".*#define H5_VERS_MAJOR.*([0-9]+).*" "\\1" HDF5_MAJOR_VERSION "${HDF5_VERSION_H_CONTENTS}")

FILE ( STRINGS "${HDF5_INCLUDE_DIR}/H5public.h" HDF5_VERSION_H_CONTENTS REGEX "#define H5_VERS_MINOR" )

STRING ( REGEX REPLACE ".*#define H5_VERS_MINOR.*([0-9]+).*" "\\1" HDF5_MINOR_VERSION "${HDF5_VERSION_H_CONTENTS}")

FILE ( STRINGS "${HDF5_INCLUDE_DIR}/H5public.h" HDF5_VERSION_H_CONTENTS REGEX "#define H5_VERS_RELEASE" )

STRING ( REGEX REPLACE ".*#define H5_VERS_RELEASE.*([0-9]+).*" "\\1" HDF5_RELEASE_VERSION "${HDF5_VERSION_H_CONTENTS}")
