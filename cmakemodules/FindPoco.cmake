...
# Look for the poco binary path.
	...
	IF (LIB${COMPONENT})
      ...
      SET ( Poco_${UPPERCOMPONENT}_FOUND TRUE )
    ELSE (LIB${COMPONENT})
      SET ( Poco_${UPPERCOMPONENT}_FOUND FALSE )
	ENDIF(LIB${COMPONENT})
      SET ( Poco_${UPPERCOMPONENT}_LIBRARY "${LIB${COMPONENT}}" )
...
MARK_AS_ADVANCED( Poco_INCLUDE_DIR Poco_LIBRARY_DIR )
